                    ...
                    <div class="card-body">
                        <form action="#" id="basicform" data-parsley-validate="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputCategoryImageUrl" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="http://www.billysburgers.com/img/burgers.jpg" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
